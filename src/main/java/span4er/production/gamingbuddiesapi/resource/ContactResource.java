...
import span4er.production.gamingbuddiesapi.service.ContactService;
...
public class ContactResource {
    ...
    public ResponseEntity<Page<Contact>> getContacts(@RequestParam(value = "page", defaultValue = "0") int page,
                                                     ...
                                                     @RequestBody ContactFilter searchBody) {
        return ResponseEntity.ok().body(contactService.searchContacts(page, size, searchBody));
    }
